            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                if(FirebaseAuth.instance.currentUser != null){
                  ...
                  if(imageContainer == "") {
                    imageContainer = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fcommons.wikimedia.org%2Fwiki%2FFile%3AImage_not_available.png&psig=AOvVaw1jnewSVUq9zED7IDVLm-3Q&ust=1701093717852000&source=images&cd=vfe&ved=0CBIQjRxqFwoTCJj5xb3p4YIDFQAAAAAdAAAAABAE";
                  }

                  if(imageContainer2 == "") {
                    imageContainer2 = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fcommons.wikimedia.org%2Fwiki%2FFile%3AImage_not_available.png&psig=AOvVaw1jnewSVUq9zED7IDVLm-3Q&ust=1701093717852000&source=images&cd=vfe&ved=0CBIQjRxqFwoTCJj5xb3p4YIDFQAAAAAdAAAAABAE";
                  }

                  if(imageContainer3 == "") {
                    imageContainer3 = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fcommons.wikimedia.org%2Fwiki%2FFile%3AImage_not_available.png&psig=AOvVaw1jnewSVUq9zED7IDVLm-3Q&ust=1701093717852000&source=images&cd=vfe&ved=0CBIQjRxqFwoTCJj5xb3p4YIDFQAAAAAdAAAAABAE";
                  }

                  if(imageContainer4 == "") {
                    imageContainer4 = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fcommons.wikimedia.org%2Fwiki%2FFile%3AImage_not_available.png&psig=AOvVaw1jnewSVUq9zED7IDVLm-3Q&ust=1701093717852000&source=images&cd=vfe&ved=0CBIQjRxqFwoTCJj5xb3p4YIDFQAAAAAdAAAAABAE";
                  }

                  await ProductFetchThroughFirebase.addProductData(dropdownValue, nameTextController.text, shortDescTextController.text, longDescTextController.text, int.parse(quantityTextController.text), priceTextController.text, imageContainer, imageContainer2, imageContainer3, imageContainer4);
