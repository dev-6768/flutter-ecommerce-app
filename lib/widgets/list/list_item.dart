    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          ItemsForCatalogue.productItemList = UpdationOfStateVariables.productItemListUpdation(image1ProductsPage, image2ProductsPage, image3ProductsPage, image4ProductsPage);
